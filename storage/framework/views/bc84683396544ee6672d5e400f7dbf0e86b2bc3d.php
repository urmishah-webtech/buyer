...
<div class="row  padding_0">
   <div class="">
      <div class="" id="details" class="get_qutations">
         <form action="<?php echo URL::to('get_quotations',null); ?>" method="post" class="get_qutations" id="quatationForm" enctype="multipart/form-data">
                  ...
                  <div class="col-sm-8" style="padding-left:20px;">
                     ...
                     <div class="checkbox" style="padding-right: 100px; margin-top: 3%;">
                        <label style="padding: 2px;">
                           <!-- <input type="checkbox" class="agreement" name="agreement" value="<?php echo e(Input::old('agreement')); ?>"> -->
                           <p>
                           <img src="<?php echo e(asset('images/checkedimg/uncheck.png')); ?>" id="imgClickAndChange" onclick="changeImage()" width="15px;">&nbsp; I accept to share my Business Card with the quoted suppliers.
                        </label>
                     </div>

                     <div class="checkbox" style="padding-left: 0px;">
                        <label style="padding: 2px;">
                           <img src="<?php echo e(asset('images/checkedimg/uncheck.png')); ?>" id="imgClickAndChange1" onclick="changeImage1()" width="15px;">&nbsp; I have read, understood and agreed to obey the <a target="_blank" href="<?php echo e(URL::to('buying-request')); ?>"> Buying Request Posting Rules</a>.
                        </label>
                     </div>
...
<script language="javascript">
   function changeImage() {
      if (document.getElementById("imgClickAndChange").src == "<?php echo e(asset('images/checkedimg/uncheck.png')); ?>") 
      {
         document.getElementById("imgClickAndChange").src = "<?php echo e(asset('images/checkedimg/checked.png')); ?>";
      }
      else 
      {
         document.getElementById("imgClickAndChange").src = "<?php echo e(asset('images/checkedimg/uncheck.png')); ?>";
      }

      if(document.getElementById("imgClickAndChange").src == "<?php echo e(asset('images/checkedimg/checked.png')); ?>" && document.getElementById("imgClickAndChange1").src == "<?php echo e(asset('images/checkedimg/checked.png')); ?>"){
   ...
   function changeImage1() {
      if (document.getElementById("imgClickAndChange1").src == "<?php echo e(asset('images/checkedimg/uncheck.png')); ?>") 
      {
         document.getElementById("imgClickAndChange1").src = "<?php echo e(asset('images/checkedimg/checked.png')); ?>";
      }
      else 
     {
         document.getElementById("imgClickAndChange1").src = "<?php echo e(asset('images/checkedimg/uncheck.png')); ?>";
      }
      if(document.getElementById("imgClickAndChange").src == "<?php echo e(asset('images/checkedimg/checked.png')); ?>" && document.getElementById("imgClickAndChange1").src == "<?php echo e(asset('images/checkedimg/checked.png')); ?>"){
         $('#btnSubmit').attr("disabled", false);
      }
