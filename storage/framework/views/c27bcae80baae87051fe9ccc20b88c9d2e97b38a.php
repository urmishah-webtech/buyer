      ...
      <div class="product-details" style="margin-bottom:0;">
         ...
         <div class="col-sm-5 col-md-4 col-lg-4 col-xs-12">
            <ul id="etalage" style="width: 100%!important;">
               <li style="width: 100%!important;">
                  ...
                  <img itemprop="image" style="object-fit: contain" class="etalage_thumb_image" src="<?php echo e(URL::to(''.$products->product_image_new->image,null)); ?>" alt="<?php echo e($products->product_name->name); ?>" />
                  <img itemprop="image" style="object-fit: contain" class="etalage_source_image" src="<?php echo e(URL::to(''.$products->product_image_new->image,null)); ?>" alt="<?php echo e($products->product_name->name); ?>" />
                  <?php else: ?>
                  not found
                  <?php endif; ?>
                  </a>
               ...
               <li>
                  <img itemprop="image" style="object-fit: contain" class="etalage_thumb_image" src="<?php echo e(URL::to(''.$image->image,null)); ?>" alt="<?php echo e($products->product_name->name); ?>" />
                  <img itemprop="image" style="object-fit: contain" class="etalage_source_image" src="<?php echo e(URL::to(''.$image->image,null)); ?>" alt="<?php echo e($products->product_name->name); ?>" />
               </li>
         ...
         <div style="float: left;"  class="col-sm-4 col-md-5 col-lg-5 pro-detl col-xs-12 ">
            <div class="product-information">
               ...
               <div style="margin-bottom: 4px;margin-top: 18px;color:#696763;" class="summary" itemprop="offers" itemscope itemtype="http://schema.org/AggregateOffer">
                  FOB Price :        
                  <div style="display: inline;margin-bottom:0px;padding-left:0px;" itemprop="priceCurrency" content="USD"><span class="pro_details_pad"><a style="margin-left: 18px;" href="#" data-product_id="<?php echo e($products->id); ?>" data-supplier_id="<?php echo e($products->supplier_product->supplier_id); ?>" class="contact_supplier">Get Price</a></span></div>
               </div>
               <?php endif; ?>
   ...
   <div class="col-md-12 col-sm-12" style="padding-left: 0px" data-spy="scroll" data-target="#navbar-example1">
      <div class="col-md-9 col-sm-9" style="padding-left: 0px">
         ...
         <div id="pcontact" class="col-sm-12" style="margin-bottom:30px; padding: 0px">
            <form action="<?php echo URL::to('product_details'); ?>" method="post" class="products_details_form" enctype="multipart/form-data" id="form-contact-supplier">
               <?php echo csrf_field(); ?>
