<div>
            ...
            <a class="pull-right" style="font-weight: 300; font-size: 12px" href="<?php echo e(URL::to('buying-request',null)); ?>">Learn more</a>
            </p>
            ...
            <div class="dash-frm">
                ...
                <p class="<?php echo e($errors->has('product_name')?'to-err':''); ?>" style="font-weight: bold;margin: 10px 0 5px 0;">Product Name:</p>
                <div>
                    <input class="dash-inp <?php echo e($errors->has('product_name')?'to-err2':''); ?>" type="text" name="product_name" placeholder="Please enter Product name." value="<?php echo e(Input::old('product_name')); ?>">
                    <?php if($errors->has('product_name')): ?>
                    <p class="text-danger"><?php echo e($errors->first('product_name')); ?></p>
                    <?php endif; ?>
                </div>
                <div class="dash-focus">
                    
                    <p class="<?php echo e($errors->has('details')?'to-err':''); ?>" style="font-weight: bold;margin: 10px 0 5px 0;">Product Detailed Specification:</p>
                    <div>
                        <textarea name="details" style="width: 100%; background: white; border: 1px solid #aaa;" rows="5" placeholder="Product details..." class="<?php echo e($errors->has('details')?'to-err2':''); ?>"><?php if(Input::old('details') == null || Input::old('details') == ''){echo "";}else{ echo Input::old('details');} ?></textarea>
                    ...
                    <div class="row" style="display: flex;">
                        <div class="col-sm-6">
                            <input class="<?php echo e($errors->has('quantity')?'to-err2':''); ?>" name="quantity" style="flex:1; margin-right: 5px;width:100%;" type="number" placeholder="Quantity" value="<?php echo e(Input::old('quantity')); ?>">
                            <?php if($errors->has('quantity')): ?>
                            <p class="text-danger"><?php echo e($errors->first('quantity')); ?></p>
                            <?php endif; ?>
                        </div>
                        <div class="col-sm-6">
                            <select class="<?php echo e($errors->has('unit')?'to-err2':''); ?>" name="unit" style="flex:1; padding: 2.3px;width:100%;" value="<?php echo e(Input::old('unit')); ?>">
                    ...
                    <div class="row" style="display: flex;">
                        <div class="col-sm-6">
                            <input class="<?php echo e($errors->has('unit_price')?'to-err2':''); ?>" name="unit_price" style="flex:1; margin-right: 5px;width:100%;padding: 1px;" type="text" placeholder="Preferred Unit Price" value="<?php echo e(Input::old('unit_price')); ?>">
                            <?php if($errors->has('unit_price')): ?>
                            <p class="text-danger"><?php echo e($errors->first('unit_price')); ?></p>
                            <?php endif; ?>
                        </div>
                        <div class="col-sm-6">
                            <select class="<?php echo e($errors->has('currency')?'to-err2':''); ?>" name="currency" style="flex:1; padding: 2.3px;width:100%;" value="<?php echo e(Input::old('currency')); ?>">
