...
<div class="row">
  <nav class="navbar navbar-default" aria-label="Navigation" itemscope itemtype="http://schema.org/SiteNavigationElement" style="margin-bottom: 0 !important;">
    <div class="navbar-header" style="padding: 10px;">
      ...
      <a style="margin-left: 10px; background-image: none " rel="home" itemprop="url" title="Manufacturers-Suppliers"  href="<?php echo e(URL::to('/',null)); ?>">
        <img style="width:100px; margin-top: 10px;" src="<?php echo asset('assets/logo.png'); ?>" alt="bdtdc">
     <!--  <img style="width: 90px; margin: 0 auto;" alt="logo" style="" itemprop="logo" class="loggg" src="<?php echo e(asset('assets/logo.png')); ?>" /> -->
      ...
      <div id="sign_bdtdc" class="tab-pane fade in active">
        <div style="padding: 60px 0;width: 100%;overflow: hidden;background: #fff; height: 450px;">
          <?php echo Form::open(['route' => 'sessions.store']); ?>
              ...
              <button type="submit" class="btn btn-default" style="width: 100%; margin-top: 30px;background: #FF6A00;"><span style="color: #fff; font-size: 14px;"><a itemprop="url" href="<?php echo e(URL::to('forgot_password',null)); ?>" id="forget-password" style="color:#fff !important;">FORGOT PASSWORD ?</a></span></button>
           <?php echo Form::close(); ?>
        ...
        <div style="padding: 60px 0;width: 100%;overflow: hidden;background: #fff;">
            ...
            <form action="<?php echo e(URL::to('mobile-registration/store',null)); ?>" method="post" class="form-horizontal form-row-seperated user_registration_form">
              ...
              <div class="form-group" style="position: relative;">
                ...
                <!-- <img src="<?php echo asset('assets/images/bd.gif'); ?>" id="countryFlagImg" hasloadnophoto="false" style=""> -->
                <?php 
                ...
                <select class="select_count_m" name="country" style="position: absolute;top: 10px;right: 30px;">
                  ...
                  <option value="<?php echo e($data->id); ?>" name="country"><?php echo e($data->name); ?></option>
              ...
              <div class="form-group" style="position: relative;">
               ...
               <div class="form-group" style="position: relative;">
                ...
                <div class="form-group" style="position: relative;">
                    ...
                    <a href="<?php echo URL::to('ServiceLogin'); ?>" class="btn btn-primary login_link_btn" style="    font-size: 10px;
    padding-left: 1%;
    height: 23px;
    padding-top: 1%;
...
<?php $__env->startSection('topbar_m_script'); ?>
