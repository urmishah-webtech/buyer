...
<div class="col-xs-12 padding_0">
	<div class="col-xs-3">
      <a href="<?php echo e(URL::to('/')); ?>">
			<img style="width:90px;" src="<?php echo asset('assets/logo.png'); ?>" alt="buyer Seller">
      </a>
	</div>
	<div class="col-xs-7 padding_0">
<form class="form" method="post" action="<?php echo e(URL::to('search-product',null)); ?>">
	<?php echo csrf_field(); ?>
	...
	<div class="col-xs-2 padding_0" style="padding-bottom: 10px;">
      <div id="user-pro" style="margin-bottom: 12px; margin-top:-3px;">
			<img style="width: 40px; margin-left:8px; float: right;margin-right: :30%;" src="<?php echo asset('assets/mobile-images/index.png'); ?>" alt="buyer Seller">
    </div>
	</div>
</div>
<div class="col-xs-12">
  <div class="collapse navbar-collapse m-nevbar" id="user-login-bdtdc" style="padding-right: 0; position: absolute;z-index: 99999; background: #fff; width: 100%; left: 0; border-bottom: 1px solid #ddd;">
      <div class="user-login-m">
          <div class="unregister" style="position: relative;">
                  ...
                  <div style="position: absolute;bottom: 18px;left: 15px;display: block;overflow: hidden;">
                        ...
                        <a itemprop="url" class="sng btn btn-info btn-lg" href="<?php echo e(URL::to('/logout')); ?>" style=" background: 0 none; color: #fff !important;">Logout</a>
                    <?php else: ?>
    ...
    <ul class="nav navbar-nav" style="padding-left: 20px;">
        <li class=""><a itemprop="url" href="<?php echo e(URL::to('/',null)); ?>" style="font-size: 16px; color:#666;"><span style="padding-right: 13px;"><i class="fa fa-home" aria-hidden="true" style="font-size: 22px;color:#666;"></i></span>Home<span class="sr-only">(current)</span></a></li>
       <li><a itemprop="url" href="<?php echo e(URL::to('default/chat/default',null)); ?>" style="font-size: 16px; color:#666;"><span style="padding-right: 12px;"><i class="fa fa-comment" aria-hidden="true" style="font-size: 22px;color:#666;"></i></span> Messanger</a></li>
       <li><a itemprop="url" href="<?php echo e(URL::to('default/message',null)); ?>" style="font-size: 16px; color:#666;"><span style="padding-right: 13px;"><i class="fa fa-envelope" aria-hidden="true" style="font-size: 22px;color:#666;"></i></span>Inquiries
       </a></li>
       <li><a itemprop="url" href="<?php echo e(URL::to('Mybuying-Request',null)); ?>" style="font-size: 16px; color:#666;"><span style="padding-right: 12px;"><i class="fa fa-leaf" aria-hidden="true" style="font-size: 22px;color:#666;"></i></span> Buying Request</a></li>
       <li><a itemprop="url" href="<?php echo e(URL::to('get-quotations',null)); ?>" style="font-size: 16px; color:#666;"><span style="padding-right: 12px;"><i class="fa fa-bolt" aria-hidden="true" style="font-size: 22px;color:#666;"></i></span> Quick Quotation</a></li>
       <li><a itemprop="url" href="<?php echo e(URL::to('my-favorite',null)); ?>" style="font-size: 16px; color:#666;"><span style="padding-right: 12px;"><i class="fa fa-star" aria-hidden="true" style="font-size: 22px;color:#666;"></i></span> My Favorites</a></li>
...
<div class="row" style="background: #fff;">
		<div class="templ-hed-bg">
			<div class="teplt-hd">
					...
					<a href="#">
						<?php if($customer): ?>
						<?php if($customer->company_image): ?>
					 <div class="comp-temp-logo">
						<img style="width: 48px; height: 48px;" src="<?php echo e(URL::to('uploads',$customer->company_image->image)); ?>" alt="company logo">
					 </div>
					 <?php endif; ?>					 
					</a>
			
					<div class="comany-nm-ttle" style="position: absolute;top:-6px; margin-top: 0;">
							<h4 class="nm-tle" style="font-size: 14px;"><?php echo e($customer->name_string->name); ?></h4> 
							<h5 class="cty"><!-- [ Hong Kong ] --></h5>	
							<?php if($customer->supplier_info): ?>
                      <?php else: ?>
                        <?php endif; ?>
                      <?php if($customer->supplier_info): ?>
						<div>
							<ul style="padding: 0; width: 100%; float: left;">
								<li class="icon-com-img"><img class="icon-com-img-wdt" src="<?php echo asset('assets/mobile-images/Gold-membership.png'); ?>" alt="Gold member"></li>
								<li class="icon-com-img"><?php echo e($customer->supplier_info->membership_year ?? '1'); ?> YR</li>
								<li class="icon-com-img"><img class="icon-com-img-wdt" src="<?php echo asset('assets/mobile-images/Hand-Shake-Icon.png'); ?>" alt="verified"></li>
								<li class="icon-com-img">
									<a href="<?php echo e(URL::to('BuyerChannel/pages/trade_assurance',5)); ?>" target="_blank"><img class="icon-com-img-wdt" src="<?php echo asset('assets/mobile-images/Buyer-protection-home.png'); ?>" alt="trade assurance"></a></li>
							</ul>
						</div>	
						 <?php else: ?>
...
<div class="row padding_0" style="background: #fff;">
	<div>
	    <ul class="nav nav-tabs company-temp">
		    <li class="company-temp-li"><a class="company-temp-li-a" href="<?php echo e(URL::to('Home/'.preg_replace('/[^A-Za-z0-9\-]/', '-',$customer->name_string->name),Route::current()->parameters()['profile_id'])); ?>">Home</a></li>
		    <li class="company-temp-li"><a class="company-temp-li-a" href="<?php echo e(URL::to('product-template',Route::current()->parameters()['profile_id'])); ?>">Products</a></li>
		    <li class="company-temp-li"><a class="company-temp-li-a" href="<?php echo e(URL::to(preg_replace('/[^A-Za-z0-9\-]/', '-',$customer->name_string->name).'/company-overview',Route::current()->parameters()['profile_id'])); ?>">Profile</a></li>
		    <li class="company-temp-li"><a class="company-temp-li-a" href="<?php echo e(URL::to('contact/'.preg_replace('/[^A-Za-z0-9\-]/', '-',$customer->name_string->name),Route::current()->parameters()['profile_id'])); ?>">Contact</a></li>
		</ul>
	</div>
</div>
</div>
