                                                ...
                                                <table class="table company_information_table">
                                                      <tbody>
                                                           <tr>
                                                                 ...
                                                                 <td><?php echo e(($data) ? $data->created_at : ""); ?></td>
                                                           </tr>
                                                            <tr>
                                                                 <td style="width:31%;color:#666">Year established:</td>
                                                                 <td><?php echo e(($data) ? $data->year_of_reg : ""); ?></td>
                                                           </tr>
                                                           <tr>
                                                                 <td style="color:#666">Business Type:</td>
                                                                 <td><?php echo e((($data) ? $data->business_type : "")); ?></td>
                                                           </tr>
                                                           <tr>
                                                                 <td style="color:#666">No. of Production Lines</td>
                                                                 <td><?php echo e((($data) ? $data->no_of_production_line : "")); ?></td>
                                                           </tr>
                                                           <tr>
                                                                 <td style="color:#666">Annual Output Value:</td>
                                                                 <td><?php echo e((($data) ? $data->anual_value : "")); ?> </td>
                                                           </tr>
                                                      </tbody>
