        ...
        <div class="row padding_0" style="padding-bottom: 10%;">
            ...
            <div>
                <div class="panel panel-default" style="border: 0 none; background-color: #F5F5F5; width: 570px; margin: 0 auto;">
                    ...
                    <div class="panel-body" style="margin-top: 20%;">
                        <?php if(session()->has('errormsg')): ?>
                            <div class="alert isa_error" id="flashmessage">
                                <center><?php echo e(session()->get('errormsg')); ?></center>
                            </div>
                        <?php endif; ?>
                        <?php if(session()->has('successmsg')): ?>
                            <div class="alert isa_success" id="flashmessage1">
                                <center><?php echo e(session()->get('successmsg')); ?></center>
                            </div>
                        <?php endif; ?>
                  ...
                  <div class="result">
                    <?php echo Form::open(['url'=>'subscript/change-email','method'=>'POST']); ?>
                        ...
                        <fieldset style="margin-top: 15%;">
                            ...
                            <div style="max-width: 530px; display: block; height: auto;">
                                ...
                                <div class="form-group" style="float: left;  padding-left: 15px;">
                                        <?php echo Form::text('email', null, ['placeholder' => 'Email', 'class' => 'form-control', 'required' => 'required','style'=>'width:120%;']); ?>
                            ...
                            <div style="max-width: 530px; display: block; height: auto; padding: 20px 5px;">
                                ...
                                <?php echo Form::submit('Request verification code', ['class' => 'btn btn-primary btn-block', 'style' => 'margin:0 0 0 129px; width:50%; border: 1px solid #AFAFAF;background-color: #F3F3F3;color: #777!important;font-size: 12px;font-weight: 700;']); ?>
                            ...
                            <div style="max-width: 530px; display: block; height: auto; padding:0px 5px;">
                                ...
                                <div class="form-group" style="float: left;  padding-left: 7px;">
                                           <?php echo Form::text('token', null, ['placeholder' => 'Enter the verification code', 'class' => 'form-control', 'required' => 'required','style'=>'width:120%;']); ?>
