    <?php $__env->startSection('page_css'); ?>
      <link property='stylesheet' href="<?php echo asset('css/for-suppliers/list-exhibit-sell.css'); ?>" rel="stylesheet">
    ...
    <div class="row padding_0" style="background:#ffffff; margin-bottom:28px;border-bottom: 1px solid rgba(0,0,0,.1);">
            <div class="col-sm-12 padding_0" style="/*background:#91431E;*/">
                    <!--  <img itemprop="image" style="width:100%; max-height:400px; margin-top: 36px;" src="<?php echo asset('assets/fontend/img/Exhibition-Image-for-Home.jpg'); ?>" alt="Exhibition Image for Home" /> -->
                    <img itemprop="image" style="width:100%; max-height:400px; " src="<?php echo asset('assets/country-images/global-marketplace.png'); ?>" alt="Exhibition Image for Home" />
            </div>
...
perfect patrons.</p>
        <div class="post-pay">
            <div class="post-btnnn">
                <label><a itemprop="url" href=" <?php if(Sentinel::check()): ?>
                    <?php echo e(URL::to('dashboard','product')); ?>

        <?php else: ?>
        <?php echo e(URL::to('join',null)); ?>

        <?php endif; ?>" style="color:#fff !important;">Post your products for FREE</a></label>
            </div>
            <div class="post-btnnn">
                
                 <label>
                   <a itemprop="url" href="<?php echo e(URL::to('SupplierChannel/pages/verified_supplier',32)); ?>" style="color:#fff !important;">
