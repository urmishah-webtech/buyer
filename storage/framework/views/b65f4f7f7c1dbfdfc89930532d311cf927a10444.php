...
<div class="row">
   <div class="col-sm-12 col-md-12 col-lg-12">
      <ul class="top-path" style="padding-bottom: 8px;">
         ...
         <li class="top-path-li"><a href="<?php echo e(URL::to('get-qutations',null)); ?>" class="top-path-li-a">Get Quotations<i class="fa fa-angle-right top-path-icon"></i></a></li>
      </ul>
   </div>
</div>
<div class="row  padding_0" style=" padding-bottom: ">
   <div class="col-sm-12">
      <div class="col-sm-3" id=" " style="margin-top:7%;">
         ...
         ?>
         <?php if($products->inq_products_description): ?>
            <?php $inquiry_title = $products->inq_products_description->name; ?>  
         <?php elseif($products->inquery_title != ''): ?>
            <?php $inquiry_title = $products->inquery_title; ?>
         <?php endif; ?>
         <?php if($products->inq_products_images): ?>
            <?php $inquiry_image = URL::to(''.$products->inq_products_images->image); ?>
         <?php elseif($products->inq_docs_one): ?>
            <?php $inquiry_image = URL::to('buying-request-docs',$products->inq_docs_one->docs); ?>
         <?php endif; ?>

         <div class="col-sm-12 productview" class="item_sha" style="padding: 15px;">
            <img style="height:220px;width:100%;" src="<?php echo e($inquiry_image); ?>" alt="" class="thumbnail" />

            <p class="productview" style="color: #000;font-weight: 600;font-size: 14px;padding: 5px;margin-bottom: 0;margin-top: 15px;"><a title="<?php echo e($inquiry_title); ?>" style="font-size: 12px;" target="_blank" href="<?php if($products->inq_products_description): ?> <?php echo e(URL::to('product-details/'.preg_replace('/[^A-Za-z0-9\. -]/', ' ',$products->inq_products_description->name).'='.mt_rand(100000000, 999999999).$products->product_id,null)); ?> <?php else: ?> <?php echo e(URL::to('product-sourcing/view',$products->id)); ?> <?php endif; ?>"><?php echo e(substr($inquiry_title, 0, 75)); ?>...</a></p>
         </div>
      </div>

      <?php echo Form::open(array('url'=>'quotations_form/success/quote','method'=>'POST', 'files'=>true,'class'=>'myform')); ?>
      ...
      <div class="col-sm-9">
         ...
         <div class="col-sm-12" id="details">
            <!-- <form action="<?php echo URL::to('get_qutations',null); ?>" method="post" class="get_qutations"> -->
            <input type="hidden" name="sender" value="<?php echo e($products->sender); ?>">
            <input type="hidden" name="product_owner_id" value="<?php if($products->product_owner_id != '0'): ?> <?php echo e($products->product_owner_id); ?> <?php endif; ?>">
            <input type="hidden" name="status" value="">
            <input type="hidden" name="is_quote" value="">
            <input type="hidden" name="inquery_id" value="<?php echo e($products->id); ?>">
               ...
               <div class="col-sm-12 padding_0">
                  ...
                  <div class="col-sm-6" style="padding-left:21px;">
                     ...
                     <select name="product_id" id="product_id_dorpdown" style="height: 45px !important; width: 245px !important">
                        ...
                        <?php $__currentLoopData = $quote_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single_qp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($single_qp->pro_to_cat_name): ?>
                        <option value="<?php echo e($single_qp->product_id); ?>" title="<?php echo e($single_qp->pro_to_cat_name->name); ?>"><?php echo e(substr($single_qp->pro_to_cat_name->name,0,30)); ?></option>
                        <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
         ...
         <div class="col-sm-12">
            ...
            <div class="col-sm-4" style="padding-bottom:30px">
               <select name="unit" style="margin-top: 0px;height: 45px;background-color:#fff!important;border: 1px solid #DDD;" class=" form-control productview">
                  ...
                  <option value="<?php echo e($unit->id); ?>" name=""><?php echo e($unit->name); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               </select>
            </div>
...
<div class="row" style="margin-top:3%;padding-bottom: 2%">
   <div class="category-tab">
      ...
      <ul class="nav nav-tab nav-pills trade-show-ul " style="background:none;border-bottom: 1px solid #dae2ed;">
         ...
         <li><a style="font-size: 13px;" class="padding_0 catTarget" catid="<?php echo e($cat->cat_id); ?>" href="#forbuyer" data-toggle="tab" aria-expanded="false"><?php echo e($cat->cat_name); ?></a></li>
         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
         <?php endif; ?>
      </ul>
   </div>
   ...
   $(function() {
      ...
      $("#filter_by_quote").change(function() {
         ...
         if (value == "examRoutine") {
            ...
            $.ajax({
               type: "POST",
               url: "<?php echo e(URL::to('category/products',null)); ?>",
      ...
      $(document).on({
         keyup: function() {
            var template = "";
            $(this).autocomplete({
               source: window.location.origin + "/product_suggesion/" + $(this).val() + "/<?php echo e($user_id); ?>",
