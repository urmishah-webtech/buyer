         ...
         <div style="border-bottom:1px solid #E8E8E8;padding-bottom:10%" class="row">
            <div class="col-md-12 col-xs-12 padding_0" style="    border-bottom: 1px solid #ddd;margin-bottom: 30px; padding-bottom: 10px;">
               ...
               <div class="veryfi-logo">
                  <a href="#"><img src="<?php echo e(asset('bdtdc-product-image/home-page/Verified-Suppliers-hand.png')); ?>" alt="verified"></a>
               </div>
               ...
               <span class="pull-right more" style="cursor: pointer;" ><a href="<?php echo e(URL::to('BuyerChannel/pages/accredited_suppliers',16)); ?>"> Read More &nbsp;<i class="fa fa-caret-right"></i></a></span>
            </div>
            <?php if($certificate_image): ?>
            <?php $__currentLoopData = $certificate_image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-12 col-sm-12 col-xs-12 padding_0">
               <div class="mag">
                  <h2 class="certificate-title">Certification Image</h2>
                  <img data-toggle="magnify" src="<?php echo e(URL::to('uploads',$c->image)); ?>" alt="">
               </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>  
            <?php if($trademarks_image): ?> 
            <?php $__currentLoopData = $trademarks_image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-12 col-sm-12 col-xs-12 padding_0">
               <div class="mag">
                  <h2 class="certificate-title">Trademark Certificate</h2>
                  <img data-toggle="magnify" src="<?php echo e(URL::to('uploads',$t->image)); ?>" alt="">
               </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>
            <?php if($patent_image): ?>
            <?php $__currentLoopData = $patent_image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-12 col-sm-12 col-xs-12 padding_0">
               <div class="mag">
                  <h2 class="certificate-title">Patent Certificate</h2>
                  <img data-toggle="magnify" src="<?php echo e(URL::to('uploads',$p->image)); ?>" alt="">
               </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>
            <?php if($honor_image): ?>
            <?php $__currentLoopData = $honor_image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-12 col-sm-12 col-xs-12 padding_0">
               <div class="mag">
                  <h2 class="certificate-title">Honor Certificate</h2>
                  <img data-toggle="magnify" src="<?php echo e(URL::to('uploads',$h->image)); ?>" alt="">
               </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>
