  ...
  <div class="row">
  			<div class="col-sm-12 col-md-12 col-lg-12">
		              ...
		              <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('Intellectual')); ?>" class="top-path-li-a"><span itemprop="name">Enforcement Actions for Intellectual</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
...
<?php echo $__env->make('fontend.footerpage.rules_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	      ...
	      <div class="col-sm-9 padding_0" style="padding-left:6%;padding-top:20px;">
	            ...
	            <div class="col-sm-12" style="margin-top:20px;padding-bottom:2%;padding-left:0px;">
	      			<!-- <p style="padding-top: 2%;"><a itemprop="url"  href="<?php echo e(URL::to('product_listing_policy')); ?>" style="color:#06C;font-size: 13px;font-weight: bold;">< Back to list</a></p> -->
				...
				<div class="col-sm-12 padding_0" style="padding-bottom:60px;">
					...
					<p  class="poli-dst" >
						BuyerSeller.Asia  “<a itemprop="url" href="<?php echo e(URL::to('/')); ?>" style="color: #06C;">BuyerSeller.Asia</a>” respects and regards the right of 
						Intellectual Property and vice versa. We categorically guarantee our clients that at
						 <a href="<?php echo e(URL::to('/')); ?>" style="color: #06C;">http://www.BuyerSeller.Asia/</a> the Intellectual Property contravention are utterly tackled and addressed 
						 judiciously.  
					</p>
				</div>
	      		<div class="col-sm-12 padding_0" style="padding-bottom:60px;">
				...
				<div class="col-sm-12 padding_0" style="padding-bottom:60px;">
					...
					<p style="padding-top: 5%;font-size: 14px;color: #000;text-align:left;">
						For the details of the implementations and executions click <a itemprop="url" href="<?php echo e(URL::to('/')); ?>" style="color: #06C;">
						http://www.BuyerSeller.Asia/</a>
					</p>
					<p style="padding-top: 5%;font-size: 14px;color: #000;text-align:left;padding-right:20%;">
						In any obvious or conspicuous circumstance, the <a itemprop="url" href="<?php echo e(URL::to('/')); ?>" style="color: #06C;">BuyerSeller.Asia</a> has the full authority to enforce any 
				...
				<div class="col-sm-12 padding_0" style="padding-bottom:60px;">
					...
					<p  class="poli-dst" >
						Under the forfeit of fabrication and falsification, the claims of intellectual property infringement
						 will be deployed. The intellectual property right holder makes an agreement in which they reach a
						  decision to indemnify and guarantee <a itemprop="url" href="<?php echo e(URL::to('/')); ?>" style="color: #06C;">BuyerSeller.Asia</a> free from all claims including judgements which 
					...
					<p  class="poli-dst" >
						...
						conflicting and contradictory, as this is a neutral e-business platform. The <a itemprop="url" href="<?php echo e(URL::to('/')); ?>" style="color: #06C;">
