  <?php $__env->startSection('page_css'); ?>
    <link property='stylesheet' href="<?php echo asset('css/for-buyers/why-buerseller.css'); ?>" rel="stylesheet">
...
<br>
  <div class="row">
    <div class="col-md-12 padding_0" style="padding-bottom: 1%;padding-left: 1%;">
      ...
      <li style="float: left" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="url" href="<?php echo e(URL::to('ServiceChannel/pages/for_buyer',35)); ?>" style="color: #000"> <i class="fa fa-angle-right"></i> Help Center </a></li>
        ...
        <p  class="hp">BuyerSeller gives the administrations and bolster your requirement for each progression of the excursion. With apparatuses to recognize business accomplices you can believe, you can unwind and get on with working together. </p> 
         <p  class="hp"> Be that as it may, how would you take full advantage of BuyerSeller? </p>
          ...
          <div class="cont-mid-why">
            <img itemprop="image"  style="min-height:215px;" src="<?php echo asset('assets/gold/website-function.jpg'); ?>" alt="website function">
          </div>
        </div>
        </div>
      </div>
         ...
         <div id="section-why-bdtdc2"> 
            ...
            <div>
              ...
              <div class="find-section-list11">
                   <img itemprop="image"  src="<?php echo asset('assets/gold/product-search.jpg'); ?>" alt="product search">
              </div>
            </div>
             ...
             <div>
               <div class="find-section-list1">
                  <h3 id="find-section2" class="find-h3" style="font-size: 18px;">2. Let Suppliers Find You </h3>
                      ...
                      <p><a itemprop="url" href="<?php echo e(URL::to('get_qutations')); ?>" target="_blank" class="btn btn-primary btn-join pull-left">Get Quotations Now</a></p>
                      </div>
                <div class="find-section-list11">
                   <img itemprop="image"  src="<?php echo asset('assets/gold/Let-suppliers-find-you.jpg'); ?>" alt="Choice BuyerSeller">
              </div>
            </div>
             <div>
                    <div class="find-section-list1">
                ...
                <div class="find-section-list11">
                   <img itemprop="image"  src="<?php echo asset('assets/fontend/bdtdc-images/wholesale-and-distribution.jpg'); ?>" alt="wholesale and distribution">
              </div>
            </div>
            <div id="find-section4">
                  ...
                  <h4>• Contacting Suppliers </h4>
                     ...
                     You can likewise pick Gold Suppliers, including by their number of years exchanging on Bdtdc. </p>
                      <p><a itemprop="url" href="<?php echo e(URL::to('wholesale')); ?>" target="_blank" class="btn btn-primary btn-join pull-left">Wholesale</a></p>
                      </div>
                <div class="find-section-list11">
                   <img itemprop="image"  src="<?php echo asset('assets/gold/wholesale-vendors.jpg'); ?>" alt="wholesale vendors">
              </div>
            </div>
        </div>
        </div>
...
<p><a itemprop="url" href="<?php echo e(URL::to('BuyerChannel/pages/inspection_service',19)); ?>" target="_blank" class="btn btn-primary btn-join pull-left">Arrange an Inspection </a></p>
</div>
          <div class="cont-mid-why" style="margin-top:15%;">
            <img itemprop="image"  src="<?php echo asset('assets/gold/inspaction-service.jpg'); ?>" alt="inspection services">
          </div>
         ...
         <h1 class="user-gd-head-why" style="padding-bottom:5%;font-size: 22px;">BuyerSeller Logistics</h1>
            ...
            <p class="hp">Whether your merchandise were requested at BuyerSeller or logged off direct from the industrial facility, BuyerSeller Logistics is interested in everybody. </p>
             <!-- <p><a itemprop="url" href="{-{URL::to('BuyerChannel/pages/logistic_service',18)}-}" target="_blank" class="btn btn-primary btn-join pull-left">Get A Logistics Estimate</a></p> -->
              ...
              <div class="cont-mid-why" style="margin-top:15%;">
                <img itemprop="image"  src="<?php echo asset('assets/fontend/bdtdc-images/logistics-services.jpg'); ?>" alt="logistics services">
              </div>
      ...
      <div id="section-why-bdtdc5" style="padding-bottom:5%;">         
              ...
              <div class="cont-mid-why" style="margin-top:15%;">
                        <img itemprop="image"  src="<?php echo asset('assets/gold/structured-finance.jpg'); ?>" alt="structured finance">
                </div>
    </div>
    ...
    <div class="col-md-12 padding_0 col-md-12 col-lg-12" style="margin-left: 2%;/* background-color: rgb(255, 255, 255); */border-radius: 5px!important;margin-bottom: 2%;padding-bottom: 11%; ">
      <div id="section-why-bdtdc6" style="padding-top:5%; padding-bottom:15%;">         
        ...
        <p class="hp">Your Secure Payment exchanges permit you to amass Credit Points, and later you can trade these in an intense monetary range. </p>
         <p class="hp"><a itemprop="url" href="<?php echo e(URL::to('FooterPage/pages/Secure_Payment',37)); ?>" target="_blank" class="btn btn-primary btn-join pull-left">Get More Information</a></p>
        ...
        <div class="cont-mid-why" style="margin-top:15%; padding-bottom:10%;">
                        <img itemprop="image"   src="<?php echo asset('assets/fontend/bdtdc-images/security-solutions.png'); ?>" alt="secure payment">
             </div>
          </div>
  </div>
