...
<div class="col-xs-12 padding_0" style="">
            <div class="col-xs-6">
            	<div class="cht-now">
                 <a href="<?php echo e(URL::to('default/chat/default')); ?>" style="font-size: 20px;color: #255E98;padding:0 6px;"><span><i class="fa fa-commenting-o" style="font-size: 15px; color:#255E98;" aria-hidden="true"></i></span>Chat Now</a>
                 </div>                         
            </div>
          <div class="col-xs-6">
            <div style="text-align: center; margin-bottom: 20px;" data-product_id="#" data-supplier_id="<?php echo e($supplier->users->id); ?>" class="btn btn-primary btn-join contact_supplier" style="padding:0 6px;"><i class="fa fa-envelope-o"></i>Contact Supplier</div> 
        </div>
</div>
</div>
