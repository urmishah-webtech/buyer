...
<div class="row">
  ...
  <div class="container-fluid padding_0">
  	<img itemprop="image"  style="width: 100%; display: block;" src="<?php echo asset('assets/fontend/bdtdc-images/source-season-banner.jpg'); ?>" alt="source season banner" />
  </div>
 <div class="container">
			...
			<div class="col-sm-7 col-md-7 col-lg-7">
				...
				<div class="hd" style="border-bottom: 0 none; padding-top: 6%; padding-bottom:0;">What is Dhaka Sourcing Season?</div>
					...
					<div style="padding: 5% 0; margin:0 auto;">
                		<a itemprop="url" href="<?php echo e(URL::to('apply-sourceing-meeting',null)); ?>"> <div class="btn btn-primary"  style="padding-top:10px;border-radius: 5px !important; text-align:center;">Apply to meet suppliers</div></a>
              		 </div>
			</div>
	         	...
	         	<div class="item active">
                 			<div class="col-sm-12 col-md-12 col-lg-12" style="padding-top: 7px;">
	                 					<div class="col-sm-3 col-md-3 col-lg-3">
	                 						 <img itemprop="image"  class="souc-img-list" src="<?php echo asset('assets/fontend/bdtdc-images/sourceing-in-Bangladesh-1.jpg'); ?>" alt="sourceing in Bangladesh" />
	                 					...
	                 					<div class="col-sm-3 col-md-3 col-lg-3">
	                 							 <img itemprop="image"  class="souc-img-list" src="<?php echo asset('assets/fontend/bdtdc-images/sourceing-in-Bangladesh-2.jpg'); ?>" alt="sourceing in Bangladesh" />
	                 							  <span class="visit-link">
	                 						 	<a itemprop="url"  href="#" style="text-decoration: none;color: #255E98;">
	                 						 		Source from Bangladesh, Visit BuyerSeller.Asia
	                 						 	</a>
	                 					...
	                 					<div class="col-sm-3 col-md-3 col-lg-3">
	                 						 <img itemprop="image"  class="souc-img-list" src="<?php echo asset('assets/fontend/bdtdc-images/sourceing-in-Bangladesh-3.jpg'); ?>" alt="sourceing in Bangladesh" />
	                 						  <span class="visit-link">
	                 						 	<a itemprop="url"  href="#" style="text-decoration: none;color: #255E98;">
	                 						 		Source from Bangladesh, Visit BuyerSeller.Asia
	                 						 	</a>
	                 					...
	                 					<div class="col-sm-3 col-md-3 col-lg-3">
	                 						 <img itemprop="image"  class="souc-img-list" src="<?php echo asset('assets/fontend/bdtdc-images/sourceing-in-Bangladesh-4.jpg'); ?>" alt="sourceing in Bangladesh" />
	                 						  <span class="visit-link">
	                 						 	<a itemprop="url"  href="#" style="text-decoration: none;color: #255E98;">
	                 						 		Source from Bangladesh, Visit BuyerSeller.Asia
	                 						 	</a>
          		    ...
          		    <div class="item">
              			<div class="col-sm-12 col-md-12 col-lg-12" style="padding-top: 7px;">
	                 					<div class="col-sm-3 col-md-3 col-lg-3">
	                 						 <img itemprop="image"  class="souc-img-list" src="<?php echo asset('assets/fontend/bdtdc-images/sourceing-in-Bangladesh-5.jpg'); ?>" alt="sourceing in Bangladesh" />
	                 						 <span class="visit-link">
	                 						 	<a itemprop="url" href="#" style="text-decoration: none;color: #255E98;">
	                 						 		Source from Bangladesh, Visit BuyerSeller.Asia
	                 						 	</a>
	                 					...
	                 					<div class="col-sm-3 col-md-3 col-lg-3">
	                 							 <img itemprop="image"  class="souc-img-list" src="<?php echo asset('assets/fontend/bdtdc-images/sourceing-in-Bangladesh-6.jpg'); ?>" alt="sourceing in Bangladesh" />
	                 							  <span class="visit-link">
	                 						 	<a itemprop="url" href="#" style="text-decoration: none;color: #255E98;">
	                 						 		Source from Bangladesh, Visit BuyerSeller.Asia
	                 						 	</a>
	                 					...
	                 					<div class="col-sm-3 col-md-3 col-lg-3">
	                 						 <img itemprop="image"  class="souc-img-list" src="<?php echo asset('assets/fontend/bdtdc-images/sourceing-in-Bangladesh-7.jpg'); ?>" alt="sourceing in Bangladesh" />
	                 						  <span class="visit-link">
	                 						 	<a itemprop="url" href="#" style="text-decoration: none;color: #255E98;">
	                 						 		Source from Bangladesh, Visit BuyerSeller.Asia
	                 						 	</a>
	                 					...
	                 					<div class="col-sm-3 col-md-3 col-lg-3">
	                 						 <img itemprop="image"  class="souc-img-list" src="<?php echo asset('assets/fontend/bdtdc-images/sourceing-in-Bangladesh-8.jpg'); ?>" alt="sourceing in Bangladesh" />
	                 						  <span class="visit-link">
	                 						 	<a itemprop="url" href="#" style="text-decoration: none;color: #255E98;">
	                 						 		Source from Bangladesh, Visit BuyerSeller.Asia
	                 						 	</a>
