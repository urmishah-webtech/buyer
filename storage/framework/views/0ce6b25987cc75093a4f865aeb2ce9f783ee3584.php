...
<div id="item_sha" class="row" style="margin-top: 2%;background-color: #eceef2">
   ...
   <div class="col-sm-8 padding-right">
      <div class="category-tab">
         <!--category-tab-->
         <div class="col-sm-12">
            <?php if(Session::has('update_msg')): ?>
            <p class="text-danger"><?php echo e(Session::get('update_msg')); ?></p>
            <?php endif; ?>
            <?php if(Session::has('profile_update_msg')): ?>
            <p class="text-danger"><?php echo e(Session::get('profile_update_msg')); ?></p>
            <?php endif; ?>
            ...
            <?php endif; ?>
            <?php if(Session::has('supplier_product_mag')): ?>
            <p class="text-danger"><?php echo e(Session::get('supplier_product_mag')); ?></p>
            <?php endif; ?>
            <?php if(Session::has('up_msg')): ?>
            <div id="successMessage" class="alert alert-success text-center">
               <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
               <p><?php echo e(Session::get('up_msg')); ?></p>
            </div>
            <?php endif; ?>
            <?php    
            ...
            <ul class="nav nav-tabs">
               ...
               <li style="border-right: 1px solid rgba(0,0,0,.1);"><a itemprop="url"  href="<?php echo e(URL::to('default','message')); ?>">Messages</a></li>
               ...
               <li style="border-right: 1px solid rgba(0,0,0,.1);"><a itemprop="url" target="_blank"  href="<?php echo e(URL::to('buyer/guide-bdsource')); ?>" >Buyer Guide</a></li>
               <?php else: ?>
         ...
         <div class="tab-content">
            <input type="hidden" name="section1" value="<?php echo e(($section) ? $section:''); ?>">
            <!-- ---COMPANY HOME;-- -->
            <div class="tab-pane fade" id="home">
               <div class="col-sm-12 col-md-12 col-lg-12">
                  <div style="margin-bottom:3%;" class="col-sm-12 col-md-12 col-lg-12 padding_0" >
                           ...
                           <div align="center" style="" class="col-sm-12">
                              <div style="padding-top:10px;" align="left" class="col-sm-6 padding_0">
                                 <div class="tooltip-content" style="display:none;">
                                    ...
                                    <p style="margin: 0;line-height:20px; font-size: 12px;"><span><img  style="padding-bottom: 0px;" src="<?php echo e(asset('assets/fontend/bdtdc-images/Right-icon.png')); ?>"> </span>Build Trust with 100 thousands+ Suppliers</p>
                                    <p style="margin: 0;line-height:20px; font-size: 12px;"><span><img style="padding-bottom: 0px;" src="<?php echo e(asset('assets/fontend/bdtdc-images/Right-icon.png')); ?>"> </span>Get Personalized Experience on BuyerSeller</p>
                                 </div>
                                 <?php
                                    $fff=' "<i class="fa fa-check"></i>" Verified Buyers Inquiries, Direct Contact with Buyers, Dedicated Service Agent';
                                    ?>
                                 <a  itemprop="url" itemprop="url"  href="<?php echo e(URL::to('SupplierChannel/pages/verified_supplier',32)); ?>" title="Verified supplier assessed by a world-leading inspection company (i.e SGS, Bureau Veritas). Click logo to learn more" class="gs"><img style="width: 32px;" class="" itemprop="image" style="border: none"  src="<?php echo e(asset('bdtdc-product-image/home-page/verified-supplier.png')); ?>">
                              ...
                              <div style="padding-top:10px;" align="left" class="col-sm-6">
                                 <div class="tooltip-upg" style="display: none;">
                                    <p style="margin: 0;line-height:20px; font-size: 12px;"><span><img style="padding-bottom: 0px;" src="<?php echo e(asset('assets/fontend/bdtdc-images/Right-icon.png')); ?>"> </span>Obtain comprehensive buyers profiles</p>
                                    <p style="margin: 0;line-height:20px; font-size: 12px;"><span><img style="padding-bottom: 0px;" src="<?php echo e(asset('assets/fontend/bdtdc-images/Right-icon.png')); ?>"> </span>Stand out from the crowd</p>
                                    <p style="margin: 0;line-height:20px;font-size: 12px;"><span><img style="padding-bottom: 0px;" src="<?php echo e(asset('assets/fontend/bdtdc-images/Right-icon.png')); ?>"> </span>Meet Buyers face-to-face</p>
                                 </div>
                                 <a  itemprop="url" itemprop="url" title="Gold Suppliers: pre-qualified suppliers" href="<?php echo e(URL::to('SupplierChannel/pages/suppliers_memebership',23)); ?>#upgp"  class="gs"><img style="width: 32px;" class="" itemprop="image" style="border: none" src="<?php echo e(asset('bdtdc-product-image/home-page/Gold-membership.png')); ?>" alt="Gold membership for Bdtdc"><span class="upgde"> Upgrade</span><span itemprop="name" style="display:none;">verified-supplier</span></a>
                              </div>
                              <div style="border-top:1px solid rgba(0,0,0,.1);border-bottom:1px solid rgba(0,0,0,.1);margin-top: 5px;" class="col-sm-10 padding_0">
                                 <div style="padding-top:10px;padding-bottom:10px" class="col-sm-5 padding_0">
                                    <?php if(Sentinel::check()): ?>
                                    <?php if(Sentinel::getUser()->profile_picture): ?>
                                    <img itemprop="image" style="width:100%;padding-top:5%" src="<?php echo e(URL::to('uploads',Sentinel::getUser()->profile_picture)); ?>" alt="" />
                                    <?php else: ?>
                                 ...
                                 <div style="padding-top: 15px; padding-bottom: 10px; background-color: transparent; padding-right: 0;" align="left" class="col-sm-7">
                                    <ul style="margin:0">
                                       ...
                                       <li style="padding-bottom: 5%">
                                          <a itemprop="url"  target="_blank" href="<?php echo e(URL::to('Home/'.preg_replace('/[^A-Za-z0-9\-]/', '-',$company->name_string->name),$company->id)); ?>">Visit e-store</a>
                                       </li>
                                       <li>
                                          <a itemprop="url"  target="_blank" href="<?php echo e(URL::to('Home/'.preg_replace('/[^A-Za-z0-9\-]/', '-',$company->name_string->name),$company->id)); ?>">
                                          <?php if($company->supplier_info): ?>
                                          <?php if($company->supplier_info->membership_pakacge_id): ?>
                                          <?php echo e($company->supplier_info->supp_pro_packname->name); ?> Member <?php echo e($company->supplier_info->membership_year); ?> Years
                                          <?php endif; ?>
                                          <?php else: ?>
                                          Free member
                                          <?php endif; ?>
                              ...
                              <div style="padding-bottom:20px;padding-top:5px" class="col-sm-10 padding_0">
                                 <div align="left">
                                    ...
                                    <?php if(Sentinel::check()): ?>
                                    <p class="" style="margin:0px"><?php echo e(Sentinel::getUser()->last_login); ?></p>
                                    <?php endif; ?>
                                 </div>
                              </div>
                           </div>
                              ...
                              <div class="col-md-12" style="padding-left: 0px;">
                                 <table id="example" class="table table-striped table-bordered">
                                    ...
                                    <tbody class="trade_table_body">
                                       ...
                                       <tr>
                                          <td><?php echo e($i++); ?></td>
                                          <td><a href="<?php echo e(URL::to('noticeView',$notice->id)); ?>">
                                             <?php echo e(substr($notice->title, 0, 25)); ?><?php if(strlen($notice->title) > 25): ?>... <?php endif; ?>
                                          </a>
                                          </td>
                                          <td>
                                             <a href="<?php echo e(URL::to('noticeView',$notice->id)); ?>" class="btn btn-xs btn-primary"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                          </td>
                                       </tr>
                        ...
                        <div id="caro1" class="carousel slide" data-ride="carousel" data-interval="false" style="height: 110px; overflow: hidden;">
                           <div class="carousel-inner">
                              <div class="todolist item active">
                                 <div class="todo">
                                    <a href="<?php echo e(URL::to('order-list?t='.($role?($role->role_id == 4?'sender':'product_owner_id'):'sender'),null)); ?>">
                                       <div style="color: #333333;" class="todoicon pusher_notification_3">
                                          <span class="total_new_order_wb" style="font-size: 20px;"><i data-count="<?php echo e($order_notifications); ?>" class="glyphicon notification-icon"></i></span>
                                          <span><img  src="<?php echo e(asset('assets/gold/New-Order.png')); ?>" alt="new order"> </span>
                                       </div>
                                       <p>New Orders<br>&nbsp;</p>
                                    </a>
                                 </div>
                                 <!-- <div class="todo">
                                    <a href="<?php echo e(URL::to('Mybuying-Request?unread=true',null)); ?>">
                                       <div style="color: #333333;" class="todoicon">
                                          <span class="latest_buying_request_wb" style="font-size: 20px;">0</span>
                                          <span><img  src="<?php echo e(asset('assets/gold/latest-buying-request-icon.png')); ?>" alt="new order"> </span>
                                       </div>
                                       <p>Latest Buying Requests</p>
                                    </a>
                                 </div> -->
                                 <div class="todo">
                                    <a href="<?php echo e(URL::to('Mybuying-Request?status=3',null)); ?>">
                                       <div style="color: #333333;" class="todoicon">
                                          <span class="rejected_buying_request_wb" style="font-size: 20px;"><i data-count="<?php echo e($rejected_buying_request); ?>" class="glyphicon notification-icon"></i></span>
                                          <span><img  src="<?php echo e(asset('assets/gold/Rejected-Buying-Request.png')); ?>" alt="new order"> </span>
                                       </div>
                                       <p>Rejected Buying Requests</p>
                                    </a>
                                 </div>
                                 <div class="todo">
                                    <a href="<?php echo e(URL::to('default/message',null)); ?>">
                                       <div style="color: #333333;" class="todoicon pusher_notification_1">
                                          <span class="total_new_inquiry_wb" style="font-size: 20px;"><i data-count="<?php echo e($inquiry_notifications); ?>" class="glyphicon notification-icon"></i></span>
                                          <span><img  src="<?php echo e(asset('assets/gold/Unread-Message.png')); ?>" alt="new order"> </span>
                                       </div>
                                 ...
                                 <div class="todo">
                                    <a href="<?php echo e(URL::to('Mybuying-Request?unread=true',null)); ?>">
                                       <div style="color: #333333;" class="todoicon pusher_notification_2">
                                          <span class="total_new_quote_wb" tyle="font-size: 20px;"><i data-count="<?php echo e($quote_notifications); ?>" class="glyphicon notification-icon"></i></span>
                                          <span><img  src="<?php echo e(asset('assets/gold/Qutation-Received.png')); ?>" alt="new order"> </span>
                                       </div>
                     ...
                     <div  style="border:1px solid rgba(0,0,0,.2);margin-bottom:3% ; background-color: #fff; padding: 15px" class="col-sm-12 padding_0">
                        <?php echo $__env->make('fontend.layouts.quotation-form-dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                     </div>
                  </div>
               </div>
            </div>
                        ...
                        <div class="caption caption-md">
                           ...
                           <div class="portlet-body">
                              <div class="tab-content">
                                 ...
                                 <div class="comtainer">
                                    <div class="row">
                                       <form name="supplier_profile_info" action="<?php echo URL::to('company/post_supplier_personal_info',null); ?>" method="post" class="form" enctype="multipart/form-data">
                                          <?php echo csrf_field(); ?>
                                             ...
                                             <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane active" id="personal_info">
                                                   <div style="margin-bottom:1% ;margin-top:1%" class="col-xs-12">
                                                      ...
                                                      <?php //dd($supplier); ?>
                                                      <div class="col-xs-6">
                                                         <input style="height:27px;padding-bottom:1%;font-size:12px" type="text" class="form-control" name="first_name" value="<?php echo e($supplier->first_name ?? ''); ?>" placeholder="">
                                                      </div>
                                                   </div>
                                                   <div style="margin-bottom:1% ;margin-top:1%" class="col-xs-12">
                                                      <div class="col-xs-3 padding_0 text-right">
                                                      ...
                                                      <div class="col-xs-6">
                                                         <input style="height:27px;padding-bottom:1%;font-size:12px" type="text" class="form-control" name="last_name" value="<?php echo e($supplier->last_name ?? ''); ?>" placeholder="">
                                                      </div>
                                                   </div>
                                                   <div style="margin-bottom:1% ;margin-top:1%" class="col-xs-12">
                                                      <div class="col-xs-3 padding_0 text-right">
                                                      ...
                                                      <div class="col-xs-6">
                                                         <input style="height:27px;padding-bottom:1%;font-size:12px" type="text" class="form-control" name="email" value="<?php echo e($supplier->email ?? ''); ?>" placeholder="" readonly>
                                                      </div>
                                                   </div>
                                                   <div style="margin-bottom:1% ;margin-top:1%" class="col-xs-12">
                                                      <div class="col-xs-3 padding_0 text-right">
                                                      ...
                                                      <div class="col-xs-6">
                                                         <input style="height:27px;padding-bottom:1%;font-size:12px" type="text" class="form-control" name="department" value="<?php echo e($supplier->department ?? ''); ?>" placeholder="">
                                                      </div>
                                                   </div>
                                                   <div style="margin-bottom:1% ;margin-top:1%" class="col-xs-12">
                                                      <div class="col-xs-3 padding_0 text-right">
                                                      ...
                                                      <div class="col-xs-6">
                                                         <input style="height:27px;padding-bottom:1%;font-size:12px" type="text" class="form-control" name="position" value="<?php echo e($supplier->job_title ?? ''); ?>" placeholder="">
                                                      </div>
                                                   </div>
                                                   <div style="margin-bottom:1% ;margin-top:1%" class="col-xs-12">
                                                      <div class="col-xs-4">
                                                ...
                                                <div role="tabpanel" class="tab-pane" id="change_avatar">
                                                   ...
                                                   <div class="row">
                                                      <div class="col-xs-12">
                                                         <?php if($supplier && $supplier->profile_picture): ?>
                                                         <img itemprop="image" style="width:180px;height:180px" src="<?php echo e(URL::to('uploads', $supplier->profile_picture )); ?>" alt="" class="img-thumbnail">
                                                         <?php else: ?>
                                                         <img itemprop="image" style="width:180px;height:180px" src="<?php echo e(URL::to('uploads/no-image.jpg',null)); ?>" alt="" class="img-thumbnail">
                                                         <?php endif; ?>
                                                      </div>
                                                   </div>
                                                   <div class="row">
                                       ...
                                       <form action="<?php echo e(URL::to('user/password-reset')); ?>" method="post">
                                       <?php echo csrf_field(); ?>
                     ...
                     <div class="row product_list_row">
                        ...
                        <div style="padding-left:3%;padding-right:3%" class="col-xs-12">
                           ...
                           <div class="flash-message">
                              ...
                              <p class="alert alert-<?php echo e($msg); ?>"><?php echo e(Session::get('alert-' . $msg)); ?> <a itemprop="url"  href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a></p>
                              <?php endif; ?>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                           </div>
                           <!-- <a itemprop="url"  href="" class="btn btn-primary btn-md pull-left">Product List</a> -->
                           <a itemprop="url"  href="
                              ...
                              <?php echo e(URL::to('Home/'.preg_replace('/[^A-Za-z0-9\-]/', '-',$supplier->name),$company->id)); ?>

                              <?php else: ?>
                              <?php echo e(URL::to('Home/company',$company->id)); ?>

                              <?php endif; ?>" target="_blanck" class="btn btn-primary btn-md pull-right" style="border-radius: 5px !important;">Template Preview</a>
                           ...
                           <div class="table-responsive">
                              <table style="margin-top:30px" class="table ">
                                 ...
                                 <tbody id="template_setting_bodye">
                                    <?php $__currentLoopData = $template_setting_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tsd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="text-muted" style="border-bottom:1px solid #ddd!important">
                                       <td class="text-left section_td" section_td_id="<?php echo e($tsd->section_id); ?>"><?php echo e($tsd->section_name); ?></td>
                                       <td class="section_title_logo_td">
                                          <?php if($tsd->title_logo == 1): ?>
                                          Show Both
                                          <?php elseif($tsd->title_logo == 2): ?>
                                          Title Only
                                          <?php elseif($tsd->title_logo == 3): ?>
                                          Logo Only
                                          <?php else: ?>
                                          Hide All
                                          <?php endif; ?>
                                       ...
                                       <td class="section_image_td">
                                          <?php if($tsd->section_id == 4): ?>
                                          <?php if($tsd->back_image): ?>
                                          <img itemprop="image" src="<?php echo e(URL::to('banner-images',$tsd->back_image)); ?>" width="51" height="38" title="First Slider Image">
                                          <?php endif; ?>
                                          <?php else: ?>
                                          <?php if($tsd->back_image): ?>
                                             <img itemprop="image" src="<?php echo e(URL::to('uploads',$tsd->back_image)); ?>" width="51" height="38">
                                          
                                          <?php else: ?>
                                             <img itemprop="image" width="51" height="38" src="<?php echo e(URL::to('uploads/no-image.jpg',null)); ?>" alt="" class="img-thumbnail">
                                          <?php endif; ?>
                                          <?php endif; ?>
                                       </td>
                                       <td class="section_back_color_td">
                                          <?php if($tsd->section_id == 4): ?>
                                          <?php if($tsd->back_color): ?>
                                          <img itemprop="image" src="<?php echo e(URL::to('banner-images',$tsd->back_color)); ?>" width="51" height="38" title="Second Slider Image">
                                          <?php endif; ?>
                                          <?php else: ?>
                                          <?php echo e($tsd->back_color); ?>

                                          <?php endif; ?>
                                       </td>
                                       <td class="section_font_color_td">
                                          <?php if($tsd->section_id == 4): ?>
                                          <?php if($tsd->font_color): ?>
                                          <img itemprop="image" src="<?php echo e(URL::to('banner-images',$tsd->font_color)); ?>" width="51" height="38" title="Third Slider Image">
                                          <?php endif; ?>
                                          <?php else: ?>
                                          <?php echo e($tsd->font_color); ?>
                                       ...
                                       <td class="section_height_td"><?php echo e($tsd->height); ?></td>
                                       <td class="section_width_td"><?php echo e($tsd->width); ?></td>
                                       <td>
                                          <a itemprop="url"  href="" class="btn btn-primary btn-xs section_update" data-toggle="modal" data-target="#template_setting_modal" sid="<?php echo e($tsd->id); ?>"><i class="fa fa-pencil-square-o"></i></a>
                                          <a itemprop="url"  href="<?php echo e(URL::to('supplier/section_delete',$tsd->id)); ?>" class="btn btn-danger btn-xs section_delete"  onclick="return confirm('Are you sure?')"><i class="fa fa-times"></i></a>
                                       </td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 </tbody>
            ...
            <div class="tab-pane fade" id="product" >
               <div class="portlet-body">
                  <div class="tab-content">
                     <!-- COMPANY INFO TAB -->
                     <?php if(session()->has('product_add_success')): ?>
                     <div class="col-md-12 flash-message">
                        <p class="alert alert-success"><?php echo e(session()->get('product_add_success')); ?> <a  href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a></p>
                     </div>
                     <?php endif; ?>
                     <?php if(session()->has('product_edit_success')): ?>
                     <div class="col-md-12 flash-message">
                        <p class="alert alert-success"><?php echo e(session()->get('product_edit_success')); ?> <a  href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a></p>
                     </div>
                     <?php endif; ?>
                     <div class="row product_list_row">
                        <div class="se-pre-con text-center">
                        ...
                        <div style="padding-left:3%;padding-right:3%" class="col-xs-12">
                           ...
                           <a itemprop="url"  href="<?php echo URL::to('supplier/product_create'); ?>" class="btn btn-primary btn-md pull-right" style="border-radius: 5px !important;">Add New Product</a>
                           <table style="margin-top:5%;background: #fff;" class="table ">
                              ...
                              <tbody>
                                 ...
                                 <tr class="text-muted" style="border-bottom:1px solid #ddd!important">
                                    ...
                                    <td>
                                       <a title="Edit product"  itemprop="url"  href="<?php echo e(URL::to('supplier/product_edit',$sp->product_id)); ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o"></i></a>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
            ...
            <!--<form method="POST" action="<?php echo e(URL::to('supplier/section_create',null)); ?>" accept-charset="UTF-8" id="section_form" role="form" enctype="multipart/form-data">-->
                
         </div>
          <form method="POST" action="<?php echo e(URL::to('supplier/section_create')); ?>" role='form' name="section" id="section_form" role="form" enctype="multipart/form-data">
          <div class="modal-body">
              
                 <input type="hidden" class="form_data _token" name="_token" value="<?php echo e(csrf_token()); ?>">
            ...
            <div class="form-group">
               ...
               <select name="section" id="section">
                  <?php $__currentLoopData = $template_setting_section; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tsss): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo $tsss->id; ?>"><?php echo $tsss->section_name; ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               </select>
...
<!--         <div class="modal-body">
             <form method="POST" action="<?php echo e(URL::to('supplier/section_create')); ?>" id="section_form" role="form" enctype="multipart/form-data">
                 <input type="hidden" class="form_data _token" name="_token" value="<?php echo e(csrf_token()); ?>">
             <?php echo Form::open(array('route'=>array('supplier.section_create'),'id'=>'section_form','class'=>'form-horizontal  form-row-seperated','files'=>true,'method'=>'post')); ?>
...
<script type = "text/javascript" src = "<?php echo asset('assets/fontend/js/responsiveslides.min.js'); ?>" > </script>
<script type = "text/javascript" src = "<?php echo asset('assets/dashboard/js/front_custom.js'); ?>" > </script>
<script type = "text/javascript" src = "<?php echo asset('assets/dashboard/js/spectrum.js'); ?>"> </script> 
<script type = "text/javascript" src = "<?php echo asset('assets/dashboard/js/jquery.simplePagination.js'); ?>"> </script>
...
<script type = "text/javascript">
   ...
   (function() {
      ...
      $(document).on({
         click: function(e) {
            e.preventDefault();
            var url = "<?php echo e(URL::to('supplier/product_create',null)); ?>";
            $('.modal-content').html("");
            $.get(url, function(r) {
      ...
      $(document).on({
         click: function(e) {
            e.preventDefault();
            var url = "<?php echo e(URL::to('supplier/wholesale_product_create',null)); ?>";
            $('.modal-content').html("");
            $.get(url, function(r) {
               $('.modal-content').html(r);
            })
...
//      });
   ...
   $(document).ready(function() {
      ...
      var make_focus = '<?php echo e(count($errors) > 0?1:0); ?>';
      if (make_focus == 1) {
         $('.dash-inp').focus();
      }
