...
<?php echo $__env->make('mobile-view.layout.profile-topbar', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

  <?php echo $__env->yieldContent('dashboard_content'); ?>
  
  <?php echo $__env->make('mobile-view.layout.template-footer', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
