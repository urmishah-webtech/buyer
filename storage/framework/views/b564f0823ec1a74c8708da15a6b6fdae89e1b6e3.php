...
<!-- BEGIN HEAD -->
   <head>
      ...
      <?php echo $__env->make('protected.admin.layouts.stylesheet', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
   </head>
   <!-- END HEAD -->
   <!-- BEGIN BODY -->
   ...
   <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-sidebar-closed-hide-logo">
      ...
      <?php echo $__env->make('protected.admin.layouts.scripts', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
