        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel" style="background-color:#fff; height: 320px">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item active">
                    <img itemprop="image" style="width:100%; height: 320px;" src="<?php echo asset('assets/country-images/'.$country->country_image_one->image); ?>" alt="bdtdc" class=""> <?php if($country->id==18): ?>
            ...
            <div class="business-tit">
                ...
                <div class="item">
                    <img itemprop="image" style="width:100%; height: 320px;" src="<?php echo asset('assets/country-images/'.$data->image); ?>" alt="supplier" class=""> <?php if($country->id==18): ?>
                    <!--   <div class="carousel-caption" style="top:18%; left:24%;">
            <div class="business-tit">
       </div></div> -->
        ...
        <?php endif; ?>
          <div class="img-hilight  product-hover single-products" itemscope itemtype="http://schema.org/Product" style="margin-top:5%;">
           ...
           <?php if($data->select_product_images): ?>
            <img itemprop="image" title="" style="height: 200px;width: 200px;" class="img-thumbnail bd-prduct" src="<?php echo e(URL::to(''.$data->select_product_images->image,null)); ?>" alt="<?php echo e($data->pro_name_string->name); ?>" />
          <?php else: ?>
